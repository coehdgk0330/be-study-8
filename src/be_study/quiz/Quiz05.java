...
public class Quiz05 {
	...
	public static void main(String[] args) {
		...
		System.out.println("더하기 : "+ number + "+" + number2 + "=" + (number + number2));
		System.out.println("빼기 : " + (number - number2));
		System.out.println("곱하기 : " + (number * number2));
		System.out.println("나누기 : " + ((double)number / number2));
	}
